...
admin_identity = Identity.find_or_create_by(login: ADMIN_EMAIL)
...
if Rails.env == 'development'
  ...
  foo = Identity.create(login: 'foo@peatio.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(login: 'bar@peatio.dev', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
