...
json.accounts do
  @accounts.map do |account|
    ...
    icon_url = if account.currency_obj.coin?
      ActionController::Base.helpers.image_url "/icon-#{account.currency.downcase}.png"
    else
      ActionController::Base.helpers.image_url "yarn_components/currency-flags/src/flags/#{account.currency.downcase}.png"
    end
