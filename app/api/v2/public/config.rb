  ...
  module V2
    module Public
      class Config < Grape::API
        get '/config' do
          present :currencies, Rails.cache.fetch(:public_currencies, expires_in: 600) { ::Currency.visible },
          ...
          present :markets, Rails.cache.fetch(:public_markets, expires_in: 600) { ::Market.enabled },
