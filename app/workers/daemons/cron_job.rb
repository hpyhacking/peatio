...
module Workers
  module Daemons
    class CronJob < Base
      JOBS = [Jobs::Cron::KLine, Jobs::Cron::Ticker, Jobs::Cron::StatsMemberPnl, Jobs::Cron::AML, Jobs::Cron::Refund, Jobs::Cron::WalletBalances, Jobs::Cron::CurrencyPrice, Jobs::Cron::AdjustNetworkFee].freeze
